...
3. Параметр <i>"inline"</i>, отвечает за то, будет ли клавиатура встроена в сообщение. Пример обычной и inline клавиатуры ниже.
...
```
В данном примере мы указали параметр inline со значением True, тем самым создали inline клавиатуру.
### Добавление рядов
